...
class NuevoAdminScreen extends StatefulWidget {
  ...
  const NuevoAdminScreen({super.key, required this.tenant});
  ...
  Future<void> _crearAdmin() async {
    ...
    try {
      ...
      AppTheme.showSnackBar(
        context,
        AppTheme.successSnackBar('Administrador "${_userNameController.text.trim()}" creado exitosamente'),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Nuevo Administrador', style: AppTheme.appBarTitleStyle),
                    ...
                    _buildSectionCard(
                      ...
                      children: [
                        ...
                        _buildTextFormField(
                          ...
                          label: 'Contraseña *',
                          hint: 'Mayúscula, minúscula, número, 8+ caracteres',
