...
class EditarCategoriaScreen extends StatefulWidget {
  ...
  const EditarCategoriaScreen({super.key, required this.categoria});
...
class _EditarCategoriaScreenState extends State<EditarCategoriaScreen> {
  ...
  void initState() {
    ...
    _selectedColor = widget.categoria.colorHex;
  }
  ...
  Future<void> _guardarCategoria() async {
    ...
    if (widget.categoria.id == null) return;
    ...
    try {
      ...
      if (Apihandler.isConnectionError(e)) {
        ...
        final msg = errorStr.contains('ya existe') || errorStr.contains('duplicad')
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Editar categoría', style: AppTheme.appBarTitleStyle),
